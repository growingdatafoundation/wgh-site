 ...
 */
 ...
 $( document ).ready(function() {
	...
	//get_flora_region(139.371906,-32.166980);
...
function processData(allText) {
 ...
 function get_flora_region(lon,lat){
	var url="http://whatgrowshere.com.au/apiplus/?t=getRegion&long="+lon+"&lat="+lat;
	$.getJSON( url, function( data ) {
		if(data.result!=""){
			
			var el = $('#location');
			el.val(data.result).attr('selected', true).siblings('option').removeAttr('selected');
